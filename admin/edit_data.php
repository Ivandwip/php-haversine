            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Data Lokasi Bank Sampah</h1>
                    </div>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="edit_aksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="id_lokasi" type="text" id="id_lokasi" class="form-control" value="<?php echo $data['id_lokasi']; ?>" readonly />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="nama_lokasi" type="text" id="nama_lokasi" class="form-control" value="<?php echo $data['nama_lokasi']; ?>" required />
                                        </div>
                                    </div>
